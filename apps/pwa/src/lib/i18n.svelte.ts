...
export const ui = {
  es: {
    ...
    'verificar.demo_banner_body': '4 de 9 ACEs ARCOTEL activas tienen raíz real cargada (Eclipsoft, Uanataca, ArgosData, Datil); las 5 restantes (ANFAC, BCE, Judicatura, Registro Civil, Security Data) siguen como placeholders. Para esas 5, la criptografía local funciona pero la cadena de confianza aún no es vinculante. Otras 8 ACEs listadas por ARCOTEL no se cuentan por no tener operación pública activa.',
  ...
  en: {
    ...
    'verificar.demo_banner_body': '4 of 9 active ARCOTEL CAs have real roots loaded (Eclipsoft, Uanataca, ArgosData, Datil); the remaining 5 (ANFAC, BCE, Judicatura, Registro Civil, Security Data) are still placeholders. For those 5 CAs, local cryptography works but the trust chain is not yet binding. 8 other ARCOTEL-listed CAs are excluded as inactive (no operational public presence).',
