import { sha256 as nobleSha256, sha384 as nobleSha384, sha512 as nobleSha512 } from '@noble/hashes/sha2';
...
export async function digest(algo: HashAlgo, data: Uint8Array): Promise<Uint8Array> {
  ...
  try {
    ...
    switch (algo) {
      ...
      case 'SHA-384': return nobleSha384(data);
      case 'SHA-512': return nobleSha512(data);
    }
  }
}
