...
### Notas
- Tres tests nuevos (bloque estrecho a 300 pt: recorta; ancho explicito: no recorta; raya vecina a 0,9 pt: no la roza). La mutacion `widthIsDefault=false` mata los dos de recorte y dos entradas de la tabla congelada (el de ancho explicito guarda la direccion contraria: que un `boxW` elegido no se toque).
