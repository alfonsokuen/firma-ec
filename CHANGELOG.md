...
- **La estampa del segundo firmante flota por encima de su raya en vez de apoyarse en ella.** El hueco se busca por franjas horizontales de pagina completa, asi que una firma previa a la DERECHA bloquea toda la altura aunque no estorbe a la columna izquierda. Medido en el NDA: y=263 cuando la raya esta en 222. Pide una busqueda de hueco consciente de la columna.
...
- **El SEGUNDO firmante**: un documento que ya trae una firma previa —justo cuando hay dos columnas— entra por `anti-overlap` y no pasa por esta logica.
