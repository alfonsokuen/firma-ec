...
export const ui = {
  es: {
    ...
    'verificar.demo_banner_body': '7 de 9 ACEs ARCOTEL activas tienen raíz real cargada (Eclipsoft, Uanataca, ArgosData, Datil, BCE, Security Data, ANFAC); las 2 restantes (Judicatura, Registro Civil) siguen como placeholders. Para esas 2, la criptografía local funciona pero la cadena de confianza aún no es vinculante. Otras 8 ACEs listadas por ARCOTEL no se cuentan por no tener operación pública activa.',
  ...
  en: {
    ...
    'verificar.demo_banner_body': '7 of 9 active ARCOTEL CAs have real roots loaded (Eclipsoft, Uanataca, ArgosData, Datil, BCE, Security Data, ANFAC); the remaining 2 (Judicatura, Registro Civil) are still placeholders. For those 2 CAs, local cryptography works but the trust chain is not yet binding. 8 other ARCOTEL-listed CAs are excluded as inactive (no operational public presence).',
