...
export const ui = {
  es: {
    ...
    'verificar.demo_banner_body': '3 de 17 ACEs ARCOTEL tienen raíz real cargada (Eclipsoft, Uanataca, ArgosData); las 14 restantes siguen como placeholders en el TSL local. Para esas 14, la criptografía local funciona pero la cadena de confianza aún no es vinculante.',
  ...
  en: {
    ...
    'verificar.demo_banner_body': '3 of 17 ARCOTEL CAs have real roots loaded (Eclipsoft, Uanataca, ArgosData); the remaining 14 are still placeholders in the local TSL. For those 14 CAs, local cryptography works but the trust chain is not yet binding.',
