...
export const ui = {
  es: {
    ...
    'verificar.demo_banner_body': '8 de 9 ACEs ARCOTEL activas tienen raíz real cargada (Eclipsoft, Uanataca, ArgosData, Datil, BCE, Security Data, ANFAC, Judicatura iCert-EC); falta solo 1 (Registro Civil) como placeholder. Para esa 1, la criptografía local funciona pero la cadena de confianza aún no es vinculante. Otras 8 ACEs listadas por ARCOTEL no se cuentan por no tener operación pública activa.',
  ...
  en: {
    ...
    'verificar.demo_banner_body': '8 of 9 active ARCOTEL CAs have real roots loaded (Eclipsoft, Uanataca, ArgosData, Datil, BCE, Security Data, ANFAC, Judicatura iCert-EC); only 1 (Registro Civil) remains as a placeholder. For that 1 CA, local cryptography works but the trust chain is not yet binding. 8 other ARCOTEL-listed CAs are excluded as inactive (no operational public presence).',
