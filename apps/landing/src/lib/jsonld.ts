...
export const softwareApplication = ({ lang }: OrgArgs) => ({
  ...
  // schema.org/keywords (Text): tópicos que describen la app para motores de
  // búsqueda e IA (GEO/AEO). No es el meta keywords tag (muerto): aquí es un
  // dato estructurado legítimo, en el idioma de la página.
  keywords:
    lang === 'es'
      ? 'firmar documentos, firmar documentos en línea, firmar documentos gratis, página web para firmar documentos, cómo se firma electrónicamente un documento, firma electrónica para firmar documentos, firmar documentos con firma electrónica Ecuador, firmar documentos con certificado Security Data, firmar PDF, firma electrónica Ecuador'
