 ...
 * glifo de su tabla `win1252` (la que usa `Encodings.WinAnsi`). Se generaron
 * UNA vez y se congelan aqui como dato: leerlas en caliente obligaria a inflar
 * y parsear ~200 KB de JSON comprimido por documento para consultar veinte
 * numeros.
 *
 * OJO con el cruce, que es donde fallo la primera version: esa tabla va de
 * CODE POINT UNICODE a `[codigo WinAnsi, nombre]`, no de codigo a nombre.
 * Leerla como si la clave fuera el byte solo acierta donde ambos coinciden
 * (32..126 y 160..255) y dejaba el tramo 128..159 ENTERO a cero — justo donde
 * WinAnsi mete la tipografia que aparece en los nombres reales: comillas
 * curvas (145..148), guion medio y largo (150, 151), puntos suspensivos (133),
 * bullet (149). Un apostrofo tipografico en el nombre del firmante bastaba
 * para que la linea se quedara sin borde derecho.
 *
 ...
 * como desconocido y cae al `/MissingWidth` del documento. Quedan a cero, y es
 * correcto, exactamente seis: 127 (DEL) y los cinco huecos sin asignar de
...
const STANDARD_WIDTH_ROWS: Readonly<Record<string, string>> = {
  Helvetica:
    ...
    '500 500 500 334 260 334 584 0 556 0 222 556 333 1000 556 556 333 1000 667 333 1000 0 611 0 ' +
    '0 222 222 333 333 350 556 1000 333 1000 500 333 944 0 500 500 278 333 556 556 556 556 260 ' +
    '556 333 737 370 556 584 333 737 333 400 584 333 333 333 556 537 278 333 333 365 556 834 ' +
    '834 834 611 667 667 667 667 667 667 1000 722 667 667 667 667 278 278 278 278 722 722 778 ' +
    '778 778 778 778 584 778 722 722 722 722 667 667 611 556 556 556 556 556 556 889 500 556 ' +
    '556 556 556 278 278 278 278 556 556 556 556 556 556 556 584 611 556 556 556 556 500 556 ' +
    '500',
  'Helvetica-Bold':
    ...
    '556 556 500 389 280 389 584 0 556 0 278 556 500 1000 556 556 333 1000 667 333 1000 0 611 0 ' +
    '0 278 278 500 500 350 556 1000 333 1000 556 333 944 0 500 556 278 333 556 556 556 556 280 ' +
    '556 333 737 370 556 584 333 737 333 400 584 333 333 333 611 556 278 333 333 365 556 834 ' +
    '834 834 611 722 722 722 722 722 722 1000 722 667 667 667 667 278 278 278 278 722 722 778 ' +
    '778 778 778 778 584 778 722 722 722 722 667 667 611 556 556 556 556 556 556 889 556 556 ' +
    '556 556 556 278 278 278 278 611 611 611 611 611 611 611 584 611 611 611 611 611 556 611 ' +
    '556',
  'Helvetica-Oblique':
    '278 278 355 556 556 889 667 191 333 333 389 584 278 333 278 278 556 556 556 556 556 556 ' +
    '556 556 556 556 278 278 584 584 584 556 1015 667 667 722 722 667 611 778 722 278 500 667 ' +
  ...
  'Times-Roman':
    ...
    '500 500 444 480 200 480 541 0 500 0 333 500 444 1000 500 500 333 1000 556 333 889 0 611 0 ' +
    '0 333 333 444 444 350 500 1000 333 980 389 333 722 0 444 500 250 333 500 500 500 500 200 ' +
    '500 333 760 276 500 564 333 760 333 400 564 300 300 333 500 453 250 333 300 310 500 750 ' +
    '750 750 444 722 722 722 722 722 722 889 667 611 611 611 611 333 333 333 333 722 722 722 ' +
    '722 722 722 722 564 722 722 722 722 722 722 556 500 444 444 444 444 444 444 667 444 444 ' +
    '444 444 444 278 278 278 278 500 500 500 500 500 500 500 564 500 500 500 500 500 500 500 ' +
    '500',
  'Times-Bold':
    ...
    '500 500 444 394 220 394 520 0 500 0 333 500 500 1000 500 500 333 1000 556 333 1000 0 667 0 ' +
    '0 333 333 500 500 350 500 1000 333 1000 389 333 722 0 444 500 250 333 500 500 500 500 220 ' +
    '500 333 747 300 500 570 333 747 333 400 570 300 300 333 556 540 250 333 300 330 500 750 ' +
    '750 750 500 722 722 722 722 722 722 1000 722 667 667 667 667 389 389 389 389 722 722 778 ' +
    '778 778 778 778 570 778 722 722 722 722 722 611 556 500 500 500 500 500 500 722 444 444 ' +
    '444 444 444 278 278 278 278 500 556 500 500 500 500 500 570 500 556 556 556 556 500 556 ' +
    '500',
  'Times-Italic':
    ...
    '444 444 389 400 275 400 541 0 500 0 333 500 556 889 500 500 333 1000 500 333 944 0 556 0 0 ' +
    '333 333 556 556 350 500 889 333 980 389 333 667 0 389 444 250 389 500 500 500 500 275 500 ' +
    '333 760 276 500 675 333 760 333 400 675 300 300 333 500 523 250 333 300 310 500 750 750 ' +
    '750 500 611 611 611 611 611 611 889 667 611 611 611 611 333 333 333 333 722 667 722 722 ' +
    '722 722 722 675 722 722 722 722 722 556 611 500 500 500 500 500 500 500 667 444 444 444 ' +
    '444 444 278 278 278 278 500 500 500 500 500 500 500 675 500 500 500 500 500 444 500 444',
  'Times-BoldItalic':
    ...
    '500 444 389 348 220 348 570 0 500 0 333 500 500 1000 500 500 333 1000 556 333 944 0 611 0 ' +
    '0 333 333 500 500 350 500 1000 333 1000 389 333 722 0 389 444 250 389 500 500 500 500 220 ' +
    '500 333 747 266 500 606 333 747 333 400 570 300 300 333 576 500 250 333 300 300 500 750 ' +
    '750 750 500 667 667 667 667 667 667 944 667 667 667 667 667 389 389 389 389 722 722 722 ' +
    '722 722 722 722 570 722 722 722 722 722 611 611 500 500 500 500 500 500 500 722 444 444 ' +
    '444 444 444 278 278 278 278 500 556 500 500 500 500 500 570 500 556 556 556 556 444 500 ' +
    '444',
};
