...
export const ui = {
  es: {
    ...
    'verificar.demo_banner_body': 'v0.6.0-rc7 — 2 de 17 ACEs ARCOTEL tienen raíz real cargada (Eclipsoft, Uanataca); las 15 restantes siguen como placeholders en el TSL local. Para esas 15, la criptografía local funciona pero la cadena de confianza aún no es vinculante.',
    ...
    'install.button.aria': 'Instalar firmar.ec en tu dispositivo',
    'install.ios.title': 'Instalar en iPhone / iPad',
    'install.ios.intro': 'Safari no permite instalar automáticamente. Hazlo en 3 pasos:',
    'install.ios.step1': 'Toca el botón Compartir en la barra inferior de Safari',
    'install.ios.step2': 'Desliza y elige “Añadir a pantalla de inicio”',
    'install.ios.step3': 'Confirma. Quedará como una app más en tu pantalla.',
  ...
  en: {
    ...
    'verificar.demo_banner_body': 'v0.6.0-rc7 — 2 of 17 ARCOTEL CAs have real roots loaded (Eclipsoft, Uanataca); the remaining 15 are still placeholders in the local TSL. For those 15 CAs, local cryptography works but the trust chain is not yet binding.',
    ...
    'install.button.aria': 'Install firmar.ec on your device',
    'install.ios.title': 'Install on iPhone / iPad',
    'install.ios.intro': 'Safari does not allow automatic install. Three steps:',
    'install.ios.step1': 'Tap the Share button in the Safari bottom bar',
    'install.ios.step2': 'Scroll and pick "Add to Home Screen"',
    'install.ios.step3': 'Confirm. It will appear as a regular app on your home screen.',
