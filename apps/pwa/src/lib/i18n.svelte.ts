...
export const ui = {
  es: {
    ...
    'firmar.step3.eci_hint': 'Es el archivo que recibiste de tu ECI (BCE, Security Data, ANFAC, etc.).',
  ...
  en: {
    ...
    'firmar.step3.eci_hint': "It's the file you received from your CA (BCE, Security Data, ANFAC, etc.).",
